  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-800 mb-2">Lab Test Management</h2>
          <p className="text-gray-600">Manage lab tests and their details</p>
        </div>
        ...
        <div className="bg-white shadow-lg rounded-2xl p-6">
          <h3 className="text-xl font-semibold text-gray-800 mb-6">Lab Tests</h3>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-400 mt-2">Add your first lab test using the form above.</p>
            </div>
          ) : (
              ...
              <table className="w-full table-auto">
                <thead>
                  <tr className="bg-gray-50">
                    <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Test Name</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {labTests.map((test, index) => (
                    <tr key={test._id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">${test.price}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">{test.estimatedDuration}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
