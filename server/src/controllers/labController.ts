...
// Get all lab tests
export const getAllLabTests = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
// Get lab test by ID
export const getLabTestById = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const { id } = req.params;
